...
export const LicenseNotificationService = {
    ...
    async checkExpiringLicenses() {
        console.log('[License Notifications] Checking for expiring licenses...');
        ...
        console.log(`[License Notifications] Processed ${expiringHotels.length} hotels, sent ${notificationsSent} notifications`);
...
Please renew to avoid service interruption.`;
        ...
        console.log(`[License] Sent expiry warning to hotel ${hotelId} (${daysRemaining} days)`);
    },
