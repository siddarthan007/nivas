...
import { X, Plus, Trash2, Receipt, CreditCard, User, Bed, Calendar, Calculator, AlertCircle } from 'lucide-react';
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
                        ...
                        >
                            {processing ? 'Processing...' : payLater ? 'Checkout with Credit' : 'Complete Checkout'}
                        </Button>
                    </div>
                </div>
            </div>
