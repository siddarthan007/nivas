...
export default function GLPage() {
    ...
    return (
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', borderBottom: '1px solid var(--notion-border)', paddingBottom: '16px' }}>
                <Button
            ...
            {activeTab === 'ledger' && <AccountLedgerView accounts={accounts} />}
            {activeTab === 'cash-flow' && <CashFlowView />}
            {activeTab === 'ar-aging' && <ArAgingView />}
                            ...
                            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px', textAlign: 'left' }}>
                                ...
                                <tbody>
                                    {trialBalance.length === 0 ? (
                                        <tr><td colSpan={5} style={{ padding: '24px', textAlign: 'center', color: 'var(--notion-text-secondary)' }}>No balances found</td></tr>
                                    ) : (
    ...
    return (
        <div style={{ marginTop: '16px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                ...
                <div style={{ width: 150 }}><DateField value={asOf} onChange={setAsOf} /></div>
            </div>
            {data && (
                <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
