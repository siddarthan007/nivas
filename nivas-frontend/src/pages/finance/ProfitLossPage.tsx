...
export default function ProfitLossPage() {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
            ...
            {loading ? (
                <div className="page-center-column"><div className="animate-spin loading-spinner" /></div>
            ) : !data ? (
                <div style={{ padding: 'var(--space-8)', textAlign: 'center', color: 'var(--notion-text-secondary)' }}>No data</div>
            ) : (
                <>
