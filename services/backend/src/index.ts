...
import { planModuleMiddleware } from "./middlewares/plan-module.middleware";
import { tenantFeatureMiddleware } from "./middlewares/tenant-feature.middleware";
...
import { mobileAnalyticsController } from "./modules/analytics/mobile-analytics.controller";
...
app = app
    ...
    .use(planModuleMiddleware)
    .use(tenantFeatureMiddleware)
    .onRequest((ctx) => {
